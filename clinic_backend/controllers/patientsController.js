...
exports.deletePatient = async (req, res) => {
  ...
  // Видалити всі призначення, пов'язані з цим пацієнтом
  const appointments = await readData(appointmentsPath)
  const filteredAppointments = appointments.filter(
    (app) => app.patientId !== req.params.id,
  )
  await writeData(appointmentsPath, filteredAppointments)
